...
- Для нового проекта лучше писать явную команду:
...
- Если агент уже загрузил эти общие правила, голый путь к библиотеке, например
  `D:\AI\general-instructions`, тоже означает bootstrap: агент должен прочитать
  эти правила и развернуть локальный комплект инструкций в текущем проекте по
  шаблонам/checklist'у.
- Команды `инит D:\AI\general-instructions\`, `init D:\AI\general-instructions\`
  и `инициализируй D:\AI\general-instructions\` означают тот же
