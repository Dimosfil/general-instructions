...
- `patterns/CODE_INTELLIGENCE_ADAPTERS.md`: optional provider-neutral layer for
  symbols, call/dependency graphs, Git risk, and code health without replacing
  project memory; Repowise is the first tested adapter.
...
- `tools/project-memory/code_intelligence.py`: stdlib-only local MCP bridge with
  tool allowlists and Git freshness reporting.
